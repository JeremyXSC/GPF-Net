...
work_dir_path = "/home/xiangsuncheng/wxy/"
...
class EndoDataset_query(Dataset):
    def __init__(self, file_paths, text_path, transform=None, loader=pil_loader):
        self.file_paths = []
        self.label = []
        self.text = []
        self.text_index = []
        ...
        # self.tokenizer = BertTokenizer.from_pretrained("clinicalbert")
        self.tokenizer = AlbertTokenizer.from_pretrained(work_dir_path + 'albert-base-v2')
        for i in file_paths:
...
class EndoDataset_gallery(Dataset):
    def __init__(self, file_paths, transform=None, loader=pil_loader):
        self.file_paths = []
        self.label = []
        for i in file_paths:
            for file in os.listdir(i[0]):
...
class EndoDataset_Train(Dataset):
    def __init__(self, file_paths, text_path, index, transform=None, loader=pil_loader):
        self.file_paths = []
        self.label = []
        self.text = text_path
...
if __name__ == "__main__":
    image_root = "/home/xiangsuncheng/wxy/resized_frame"
    text_root = "/home/xiangsuncheng/wxy/process_text.xlsx"
